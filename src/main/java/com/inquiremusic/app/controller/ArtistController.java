...
/**
 * ArtistController - handles front-end logic to request all artist related details and display them in each tab of the selected results or scrollpane.
...
public class ArtistController {
	...
	/**
	 * Creates a new ArtistController object, has 4 dependencies, the MainView, TrackLogic, ArtistLogic, & AlbumLogic
	 * @param view
	 * @param services
	 * @param trackLogic
	 * @param artistLogic
